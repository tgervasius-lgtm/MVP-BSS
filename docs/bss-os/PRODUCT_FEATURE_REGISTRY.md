...
| TIME-006 | Terminal offline sync event ingestion | Yes | DEMO / IMPLEMENTED | MERGED | Device request model, nonce/replay boundaries, idempotency and reconciliation invariants | NOT DEPLOYED | Run real-device retry/offline/clock-drift tests |

...
| DEC-018 | 2026-08-08 | Codex credits should be reserved for code/reasoning work when repository administration and documentation can be performed directly through GitHub. | APPROVED / ACTIVE | Reduces unnecessary consumption of limited development-agent capacity without weakening repository evidence. | Use GitHub-native actions for focused documentation/governance changes; use Codex when code analysis, implementation or local execution materially benefits from it. |

...
| Backend quality | TypeScript, build, unit/contract/integration tests and PostgreSQL flows pass | AUTOMATED | Backend quality gate plus full-stack quality gate; PR #99 passed integration acceptance; #173 tracks test-fixture isolation and #175 tracks the reproduced RFID ordering defect and focused regression evidence in `docs/security/RFID_ASSIGNMENT_ORDERING.md`; candidate checks do not establish protected-main acceptance |

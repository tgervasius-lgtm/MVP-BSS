...
| `reports` | CURRENT BUT UPDATE | Admin tenant-wide; Voditelj dodijeljeni odjeli; Knjigovodstvo tenant-wide uz privacy-minimized `correction_log` | preview, export jobs i download | period lifecycle, locked `periodVersionId` izbor/provenance i export verification nemaju potpun aktualni UI; eksplicitni gapovi su ispod |
